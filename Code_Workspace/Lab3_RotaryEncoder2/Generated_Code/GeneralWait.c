...
** ===================================================================
*/
__attribute__((naked)) void GeneralWait_Wait10Cycles(void)
{
...
** ===================================================================
*/
__attribute__((naked)) void GeneralWait_Wait100Cycles(void)
{
...
void GeneralWait_Waitms(uint16_t ms)
{
  ...
  msCycles = GeneralWait_NofCyclesMs(1, CPU_CORE_CLK_HZ);
  while(ms>0) {
    GeneralWait_WaitLongCycles(msCycles);
    ms--;
  }
}
/*
...
*/
#if 0
void GeneralWait_WaitOSms(void)
{
