...
** ===================================================================
*/
__attribute__((naked)) void OneWireWait_Wait10Cycles(void)
{
...
** ===================================================================
*/
__attribute__((naked)) void OneWireWait_Wait100Cycles(void)
{
...
void OneWireWait_Waitms(uint16_t ms)
{
  ...
  msCycles = OneWireWait_NofCyclesMs(1, CPU_CORE_CLK_HZ);
  while(ms>0) {
    OneWireWait_WaitLongCycles(msCycles);
    ms--;
  }
}
/*
...
*/
#if 0
void OneWireWait_WaitOSms(void)
{
